package no.imr.nmdapi.nmdcruise.full;
...
public class TestFull {
    ...
    public void testFull() throws Exception {
        ...
        mockMvc.perform(
                ...
                .content(FileUtils.readFileToString(new File(this.getClass().getClassLoader().getResource("cruise_1.xml").getFile()), "UTF-8"))
                )
                .andDo(print())
                .andExpect(status().isOk());
        // Verify that data is there.
        final String insertedFile = FileUtils.readFileToString(new File(this.getClass().getClassLoader().getResource("cruise_1.xml").getFile()), "UTF-8");
        ...
        mockMvc.perform(
                ...
                .contentType(MediaType.APPLICATION_XML)
                .characterEncoding("UTF-8")
                .content(FileUtils.readFileToString(new File(this.getClass().getClassLoader().getResource("cruise_2.xml").getFile()), "UTF-8"))
                )
                .andExpect(status().isOk());

        // Verify that data is there.
        String updatedFile = FileUtils.readFileToString(new File(this.getClass().getClassLoader().getResource("cruise_2.xml").getFile()), "UTF-8");
    ...
    public void testFailure() throws Exception {
        ...
        mockMvc.perform(
                ...
                .contentType(MediaType.APPLICATION_XML)
                .characterEncoding("UTF-8")
                .content(FileUtils.readFileToString(new File(this.getClass().getClassLoader().getResource("cruise_failure.xml").getFile()), "UTF-8"))
                )
